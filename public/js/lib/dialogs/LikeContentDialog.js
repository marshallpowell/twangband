...
$(document).ready(function () {
    (function (tb, $, undefined) {
        ...
        var getLikeTxt = function(type, likeContentDto){

            var contextText = 'like';
            if(type == 'user'){
                contextText = 'follow';
            }

            if(likeContentDto.like){
                return 'un'+contextText;
            }
        ...
        tb.dialogs.activities.toggleLike = function(entityId){
            ...
            if(likeContentDto.entityType == 'user'){
                likeTxt = 'follow';
                unlikeTxt = '(unfollow)';
            }
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    if(data.errors.length){
                        ...
                        $('#_'+data.result.entityId+'_likeLinkTxt').html(getLikeTxt(likeContentDto.entityType, likeContentDto));
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    if(data.errors.length){
                        ...
                        $('#likesUserListDialog').modal('show');
                    }
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    if(data.errors.length){
                        ...
                        $('#_'+data.result.entityId+'_likeLinkTxt').html(getLikeTxt(type, data.result));
